...
function WorkoutForm() {
  ...
  return (
    <div className="w-full max-w-6xl mt-10 mx-auto bg-white dark:bg-dark-800 p-6 rounded-lg shadow-xl overflow-hidden border border-gray-100 dark:border-dark-700 transition-colors">
      ...
      <h2 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-6">Add Workout</h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <label htmlFor="workout" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
