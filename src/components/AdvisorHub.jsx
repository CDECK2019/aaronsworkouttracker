            ...
            <div className="bg-gray-800 rounded-2xl p-6 max-w-md w-full border border-gray-700">
                ...
                <form onSubmit={handleSubmit}>
                    <input
                        ...
                        className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 mb-4"
                    />
                    <div className="flex gap-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-4 py-2 bg-gray-700 text-gray-300 rounded-xl hover:bg-gray-600 transition-colors"
                        >
                            Cancel
                        </button>
                        <button
...
const CategorySelector = ({ onSelect }) => {
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-6">
            <h1 className="text-3xl font-bold text-white mb-3">AI Advisor</h1>
    ...
    return (
        <div className="min-h-[60vh] p-6">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">{category.name} Advisor</h1>
                    <p className="text-gray-400">Choose your advisor's perspective</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {category.frameworks.map((framework) => (
                    <button
                        ...
                        className={`p-5 rounded-xl border border-gray-700 bg-gray-800/50 hover:border-gray-500 transition-all duration-300 text-left group hover:bg-gray-800`}
                    >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400">{category.name} Advisor</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                {isLoading && (
                    <div className="flex gap-3">
                        ...
                        <div className="bg-gray-700 rounded-2xl rounded-bl-sm p-4">
            ...
            <div className="p-4 border-t border-gray-700">
                <div className="flex gap-3">
                    <input
                        ...
                        disabled={isLoading}
                        className="flex-1 px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 disabled:opacity-50"
                    />
                    <button
                        onClick={handleSend}
    ...
    return (
        <div className="min-h-screen bg-gray-900">
            ...
            <button
                ...
                className="fixed top-4 right-4 p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors z-40"
                title="API Settings"
            >
